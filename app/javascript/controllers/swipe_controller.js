    ...
    function poof() {
      if (!frame) {
        ...
        (function addConfetto() {
          ...
          timer = setTimeout(addConfetto.bind(this), spread * random());
        }).bind(this)();
        ...
        const loop = (timestamp) => {
          ...
          if (confetti.length !== 0) {
            frame = requestAnimationFrame(loop); // Continue the loop
          } else {
            // Cleanup
            document.body.removeChild(container);
            frame = undefined;
            this.running = true; // Set to false once everything is cleaned up
